...
namespace AuthenticatorServices
{
    public class AuthenticatorEndpointHandler : DelegatingHandler
    {
        ...
        private readonly AuthenticatorServiceModel _authorisationSettings;
        ...
        public AuthenticatorEndpointHandler(
            ...
            IOptions<AuthenticatorServiceModel> appSettings,
            IMemoryCache memoryCache,
            ILogger<AuthenticatorEndpointHandler> logger)
        {
            _authTokenService = authTokenService;
            _authorisationSettings = appSettings.Value;
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                var setting = _authorisationSettings.Settings.FirstOrDefault(c => key.IndexOf(c.Endpoint, StringComparison.OrdinalIgnoreCase) == 0);
